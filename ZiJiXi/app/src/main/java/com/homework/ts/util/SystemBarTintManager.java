...
//                mNavBarAvailable = a.getBoolean(1, false);
    ...
    public static class SystemBarConfig {
        ...
        /**
         * Get the activity_sign_up inset for any system UI that appears at the top of the screen.
         *
         * @param withActionBar True to include the height of the action bar, False otherwise.
         * @return The activity_sign_up inset (in pixels).
         */
        ...
        /**
         * Get the activity_sign_up inset for any system UI that appears at the bottom of the screen.
         *
         * @return The activity_sign_up inset (in pixels).
         */
        ...
        /**
         * Get the activity_sign_up inset for any system UI that appears at the right of the screen.
         *
         * @return The activity_sign_up inset (in pixels).
         */
